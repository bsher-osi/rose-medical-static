...
<script type="text/javascript" src="/wp-includes/js/mediaelement/mediaelement-and-player.min.js?ver=4.2.17"></script>
<script type="text/javascript" src="/wp-includes/js/mediaelement/mediaelement-migrate.min.js?ver=6.9.4"></script>
...
<script type="text/javascript" src="/wp-includes/js/mediaelement/wp-mediaelement.min.js?ver=6.9.4"></script>
<script type="text/javascript" src="/wp-content/themes/mediclinic/assets/js/modules/plugins/jquery.prettyPhoto.js?ver=6.9.4"></script>
<script type="text/javascript" src="/wp-content/themes/mediclinic/assets/js/modules/plugins/perfect-scrollbar.jquery.min.js?ver=6.9.4"></script>
<script type="text/javascript" src="/wp-content/themes/mediclinic/assets/js/modules/plugins/ScrollToPlugin.min.js?ver=6.9.4"></script>
<script type="text/javascript" src="/wp-content/themes/mediclinic/assets/js/modules/plugins/parallax.min.js?ver=6.9.4"></script>
<script>
var mkdfGlobalVars = {{"vars":{{"mkdfAddForAdminBar":0,"mkdfElementAppearAmount":-100,"mkdfAjaxUrl":"/wp-admin/admin-ajax.php","mkdfStickyHeaderHeight":0,"mkdfStickyHeaderTransparencyHeight":70,"mkdfTopBarHeight":46,"mkdfLogoAreaHeight":0,"mkdfMenuAreaHeight":136,"mkdfMobileHeaderHeight":70}}}};
var mkdfPerPageVars = {{"vars":{{"mkdfStickyScrollAmount":0,"mkdfHeaderTransparencyHeight":0}}}};
if(typeof window.fluidvids === 'undefined') window.fluidvids = {{init:function(){{}}}};
if(typeof window.MediaElement === 'undefined') window.MediaElement = function(){{}};
</script>
