import{a7 as P,b as T}from"./app-core.ae890a3f.js";import{_ as d}from"./vendor-other.7b559694.js";import{n as x,aq as g,f as C,i as A,j as M,a0 as _,R as y,Q as N,T as k,M as R,ae as W,U as O,P as H,ax as j}from"./vendor-vue-ui.de3ab35f.js";import{_ as G}from"./Button.a549093d.js";import{B as q}from"./Img.218d4bc6.js";import{B as D}from"./Input.8918dec2.js";import{S as J}from"./Plus.d276bd63.js";import{_ as Y}from"./Trash.d35f8063.js";import{_ as F}from"./_plugin-vue_export-helper.eefbdd86.js";const b="all-in-one-seo-pack",L=()=>typeof window.wp?.media=="function"?window.wp.media:typeof window.parent?.wp?.media=="function"?window.parent.wp.media:null,Q=()=>{let e=null;const n=({title:i,buttonText:a,multiple:s=!1,type:r=null,onSelect:c})=>{e=L()({title:i,button:{text:a},multiple:s,library:r?{type:r}:{}}),e.on("select",()=>{const u=e.state().get("selection"),l=u.first();l&&c(s?u.toJSON():l.toJSON())}),e.on("close",()=>e.detach()),x(()=>{e.open()})},t=({multiple:i=!1,type:a=null,onSelect:s})=>{const u=(T().aioseo?.urls?.home||window.location.origin).replace(/\/$/,"")+"/wp-admin/",l=new URLSearchParams({breakdance_wpuiforbuilder_media:"1"});a&&l.set("types",a),i&&l.set("multiple","1");const o=document.createElement("div");if(o.className="aioseo-media-uploader-overlay",o.innerHTML=`
